<section class="section">
    <div class="row justify-content-center" id="basic-table">
        <div class="col-12 col-md-6"> <!-- Form Hitung Volume Bola -->
            <div class="card bg-light-gray">
                <div class="card-header">
                    <h4 class="card-title" style="text-transform: uppercase; font-size: 30px; text-align: center;">MENGHITUNG VOLUME BOLA</h4>
                </div>
                <div id="content">
                                    ...
                                    <div class="card bg-light-gray">
                                        <div class="card-body">
                                            ...
                                            <div class="image-container">
                                                <img src="<?= base_url('images/bola.jpg') ?>" alt="image description" class="center-image" />
                                            </div>

                                            <!-- Judul -->
                                            <h4 class="text-center">Hitung Volume Bola</h4>

                                            <p class="text-center" style="font-size: 1em; font-weight: bold;">
    Rumus: <span style="font-size: 1.1em;">V = ⁴⁄₃ × π × r³</span><br>
    atau <span style="font-size: 1.1em;">V = ⁴⁄₃ × π × jari-jari³</span>
</p>
...
<script>
    ...
    if (!jariJari || isNaN(jariJari)) {
        alert('Masukkan angka yang valid untuk jari-jari!');
        return;
    }

    // Hitung volume bola
    let volume = (4 / 3) * Math.PI * Math.pow(jariJari, 3); // Volume = (4/3) × π × r³

    // Tampilkan hasil di halaman
    let hasil = `V = (4/3) × π × r³ = (4/3) × π × (${jariJari}³) = ${volume.toFixed(2)}`;
    ...
    fetch('<?= base_url('home/simpan_history_v_bola') ?>', {
        method: 'POST',
        body: formData
    })
