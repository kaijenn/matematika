<section class="section">
    <div class="row justify-content-center" id="basic-table">
        <div class="col-12 col-md-6"> <!-- Form Hitung Volume Kerucut -->
            <div class="card bg-light-gray">
                <div class="card-header">
                    <h4 class="card-title" style="text-transform: uppercase; font-size: 30px; text-align: center;">MENGHITUNG VOLUME KERUCUT</h4>
                </div>
                <div id="content">
                                    ...
                                    <div class="card bg-light-gray">
                                        <div class="card-body">
                                            ...
                                            <div class="image-container">
                                                <img src="<?= base_url('images/kerucut.png') ?>" alt="image description" class="center-image" />
                                            </div>

                                            <!-- Judul -->
                                            <h4 class="text-center">Hitung Volume Kerucut</h4>

                                            <p class="text-center" style="font-size: 1em; font-weight: bold;">
    Rumus: <span style="font-size: 1.1em;">V = ¹⁄₃ × π × r² × t</span><br>
    atau <span style="font-size: 1.1em;">V = ¹⁄₃ × π × jari-jari² × tinggi</span>
</p>
...
<script>
    ...
    document.getElementById("hitungVolumeForm").addEventListener("submit", function(event) {
        ...
        let volume = (1/3) * Math.PI * Math.pow(jariJari, 2) * tinggi; // Volume = (1/3) × π × r² × t

        // Tampilkan hasil di halaman
        let hasil = `V = (1/3) × π × r² × t = (1/3) × π × (${jariJari}²) × ${tinggi} = ${volume.toFixed(2)}`;
        ...
        fetch('<?= base_url('home/simpan_history_v_kerucut') ?>', {
            method: 'POST',
            body: formData
        })
